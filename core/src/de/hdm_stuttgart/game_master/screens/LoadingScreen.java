...
public class LoadingScreen extends ScreenAdapter {
    ...
    public LoadingScreen(){
        ...
        //old version - not used ToDo: delete???
        ScreenHandler.manager.load("game_characters/rangedDD/Idle/IdleAtlas.atlas", TextureAtlas.class);
        ScreenHandler.manager.load("game_characters/rangedDD/Run/RunAtlas.atlas", TextureAtlas.class);

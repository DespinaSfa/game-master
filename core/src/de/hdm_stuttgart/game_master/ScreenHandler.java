...
public class ScreenHandler extends Game {
    ...
    public void create () {
        ...
        particles.load(Gdx.files.internal("menuscreens/particleEffect/GameMenuparticles.p"), Gdx.files.internal("menuscreens/particleEffect"));
        particles.getEmitters().first().setPosition(Gdx.graphics.getWidth() / 2, Gdx.graphics.getHeight() / 2 - Gdx.graphics.getHeight() * 2);
        particles.start();
